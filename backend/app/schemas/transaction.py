...
class TransactionFilterParams(BaseModel):
    ...
    min_amount: Optional[float] = Field(None, description="Мінімальна сума (по модулю, наприклад 100)")
    max_amount: Optional[float] = Field(None, description="Максимальна сума (по модулю, наприклад 5000)")
    start_date: Optional[date] = Field(None, description="Від", json_schema_extra={"format": "date"})
