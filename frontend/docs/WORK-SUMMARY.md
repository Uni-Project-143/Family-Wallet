...
> ⚠️ Нагадування для безпеки: `firebase-adminsdk.json` має бути на **backend**, не у frontend; `.env` — у `.gitignore`; засвічені в чаті секрети (Mongo/SendGrid) бажано перевипустити.
